export const projectList = {
  projects: [
    {
      ...
      description: {
        about: {
          text:
            "Big Dogs Huge Paws is an adoption website for a non-profit organization. I began volunteering when their previous website crashed. My primary responsibilty is to work on the frontend, in Angular/TS.",
          url:
            "https://user-images.githubusercontent.com/6379500/86557047-3f44a000-bf12-11ea-99d4-45b40a1f4418.png",
        },
    ...
    },
    {
      ...
      description: {
        ...
        wins: {
          text: "I loved working with React-router and redux on this project. This was the first time",
          url:
 ...
 "Write full coverage tests for Redux actions and reducers.",
        ...
        wins: {
          text: "I loved working with React-router and redux on this project. This was the first time I used redux instead of prop drilling and it was fantastic!",
          url:
