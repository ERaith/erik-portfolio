...
"Express",
    ...
    },
    {
      ...
      liveSite:"https://secret-sierra-69834.herokuapp.com/pokedex/team/team-rocket",
      githuburl: "https://github.com/ERaith/pmt",
      imageurl:
...
"Write full coverage tests for Redux actions and reducers.",
        ...
        wins: {
          text: "What can I say? Its a pokemon pet project. It felt fun while I was making it and I still eagerly await updating it with Hooks, getting user login implemented, adding more statistics, and creating a simulated battle mode.",
          url:
...
"React Testing Library",
 ...
 "Write full coverage tests for Redux actions and reducers.",
        ...
        wins: {
          text: "This project utilized Redux and it changed my life. I love prop drilling as much as the next Dev, but having a global store is fantastic! The next iteration would be to transition over to React Hooks. I had a ton of fun working with this team and adhering to a strict agile workflow(as dry as that sounds). ",
          url:
...
"Create an app relying on clean code practices",
        ...
        wins: {
          text: "One of our earlier projects, but the first time we worked in React. This project relies on prop drilling and keeps the user data stored in Local Storage. I thoroughly enjoyed working with React Router and had a blast creating a little breadcrumb component from scratch!  ",
          url:
            "https://user-images.githubusercontent.com/6379500/86557055-423f9080-bf12-11ea-9fa9-a2d00c49c364.png",
        },
        stack: "stack description",
